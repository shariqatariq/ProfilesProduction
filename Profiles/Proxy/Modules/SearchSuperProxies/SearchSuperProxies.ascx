<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SearchSuperProxies.ascx.cs"
    Inherits="Profiles.Proxy.Modules.SearchSuperProxies.SearchSuperProxies" %>
...
<script type="text/javascript">
    ...
    var _department = '';
    var _institution = '';
    var _departmentPermission = '';
    var _institutionPermission = '';
    ...
    function NavToPage() {
        ...
        window.location = _root + '/proxy/default.aspx?method=supersearch&currentpage=' + _page +
                '&totalrows=' + _totalrows + '&offset=' + _offset + '&totalpages=' + _totalpages + '&subject=' + _subject +
                '&fname=' + _fname + '&lname=' + _lname + '&institution=' + _institution + '&department=' + _department + '&institutionpermission' + _institutionPermission + '&departmentpermission';
    }
...
<div style="margin-top: 10px;">
    ...
    <asp:Panel ID="superProxyPermissions" runat="server" Visible="false">
        
    <h2>Set permissions for Super Proxy</h2>
        <h3>WARNING: Not selecting from the dropdown will give them rights over all of that category</h3>
        <div class="content_container">
            <div class="tabContainer" style="margin-top: 0px;">
                <div class="searchForm">
                    <div class="searchSection">
                        <table border="0" cellspacing="0" cellpadding="0" class="searchForm">
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="drpInstitutionPermissions" runat="server" Width="255px" AutoPostBack="false" /> 
                                </td>
                            </tr>
                            <tr>
                                <th>
                                ...
                                <td>
                                    <asp:DropDownList ID="drpDepartmentPermissions" runat="server" Width="255px" AutoPostBack="false" /> 
                                </td>
                            </tr>
                        </table>
                    </div>
   ...
   <asp:Panel ID="pnlProxySearchResults" runat="server" Visible="false">
    <br />
    <b>Click a user to give them the above permissions</b>
    <br />
