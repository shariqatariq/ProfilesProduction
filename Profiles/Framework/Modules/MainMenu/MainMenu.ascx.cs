...
namespace Profiles.Framework.Modules.MainMenu
{
    public partial class MainMenu : BaseModule
    {
        ...
        private void DrawProfilesModule()
        {
            ...
            menulist.Append("<li><a href='" + Root.Domain + "/about/default.aspx'>About / FAQ</a></li>");
            ...
            if (base.MasterPage.CanEdit && (data.GetSessionSecurityGroup() == -50 || data.GetSessionSecurityGroup() == -40))
            {
                menulist.Append("<li><a href='" + Root.Domain + "/edit/" + subject.ToString() + "'>Edit This Profile</a></li>");
            }

            if (data.GetSessionSecurityGroup() == -50 || data.GetSessionSecurityGroup() == -40)
            {
            ...
            */
            ...
            //adding DIRECT page to the tab
            menulist.Append("<li><a href='" + Root.Domain + "/direct/default.aspx'>DIRECT2Experts</a></li>");
